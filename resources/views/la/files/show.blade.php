    ...
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $file->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Files", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/files/'.$file->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Files", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.files.destroy', $file->id], 'method' => 'delete', 'style'=>'display:inline']) }}
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
                        @la_display($module, 'original')
						@la_display($module, 'copy')
						@la_display($module, 'date')
						@la_display($module, 'expire_date')
