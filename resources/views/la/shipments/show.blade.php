...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $shipment->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Shipments", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/shipments/'.$shipment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Shipments", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.shipments.destroy', $shipment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/shipments') }}" data-toggle="tooltip" data-placement="right" title="Back to Shipments"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
						...
						@la_display($module, 'transport')
						@la_display($module, 'commodity')
						@la_display($module, 'pkgs')
						@la_display($module, 'kgs')
						@la_display($module, 'pol')
						@la_display($module, 'pod')
						@la_display($module, 'eta')
						@la_display($module, 'etd')
						@la_display($module, 'date')
						@la_display($module, 'machine_no')
                    </div>
                </div>
            </div>
        </div>
