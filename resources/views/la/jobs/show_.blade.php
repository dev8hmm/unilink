...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        ...
        <div class="col-md-1 actions">
            @la_access("Jobs", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/jobs/'.$job->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Jobs", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jobs.destroy', $job->id], 'method' => 'delete', 'style'=>'display:inline']) }}
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
                        @la_display($module, 'job_no')
						@la_display($module, 'customer_id')
						@la_display($module, 'imp_exp_id')
						@la_display($module, 'shipment_id')
						@la_display($module, 'date')
						@la_display($module, 'process')
                    </div>
                </div>
            </div>
        </div>
