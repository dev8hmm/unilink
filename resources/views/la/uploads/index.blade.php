...
<div class="box box-success">
	<div class="box-header text-right"> 
        <label for="">Type File Name (include words) :</label>
        <input type="text" name="name" id="search-name" style="width=150px;height:26px;" value="{{request()->get('name')}}">
        <button id="btn-search" class="btn btn-sm btn-warning">Search</button>
    </div>
	<div class="box-body">
